function AboutPage() {
  return (
    <section className="text-center">
      <h2 className="text-3xl font-bold text-blue-400 mb-6">Про проєкт</h2>
      ...
      <h3 className="text-2xl font-semibold text-blue-300 mb-3">🔧 Технології:</h3>
      <ul className="list-disc text-xl list-inside text-white text-base mb-6 space-y-1">
        <li>
        ...
        <li>
          🎨 <strong>MUI</strong>- це бібліотека компонентів для створення інтерфейсу користувача
        </li>
        <li>
      ...
      <h3 className="text-2xl font-semibold text-blue-300 mb-3">🎯 Чому цей проєкт важливий:</h3>
      <p className="text-white text-xl mb-6 leading-relaxed">
      ...
      <h3 className="text-2xl font-semibold text-blue-300 mb-3">👨‍💻 Автор проєкту:</h3>
